...
public class SuitLocker : StateMachineComponent<SuitLocker.StatesInstance>
{
	public class ReturnSuitWorkable : Workable
	{
		...
		public void CreateChore()
		{
			if (urgentChore == null)
			{
				...
				urgentChore = new WorkChore<ReturnSuitWorkable>(Db.Get().ChoreTypes.ReturnSuitUrgent, this, null, null, true, null, null, null, true, null, false, false, null, false, true, false, PriorityScreen.PriorityClass.personalNeeds, 5, false, false);
				...
				idleChore = new WorkChore<ReturnSuitWorkable>(Db.Get().ChoreTypes.ReturnSuitIdle, this, null, null, true, null, null, null, true, null, false, false, null, false, true, false, PriorityScreen.PriorityClass.idle, 5, false, false);
	...
	public class States : GameStateMachine<States, StatesInstance, SuitLocker>
	{
		...
		public override void InitializeStates(out BaseState default_state)
		{
			...
			state2.ToggleStatusItem(tooltip, icon, name, icon_type, notification_type, false, default(HashedString), 0, null, null, main);
	...
	private void CreateFetchChore()
	{
		...
		fetchChore = new FetchChore(storageFetch, component, amount, outfitTags, null, forbidden_tags, null, true, null, null, null, FetchOrder2.OperationalRequirement.None, 0, null);
