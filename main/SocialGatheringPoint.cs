...
public class SocialGatheringPoint : StateMachineComponent<SocialGatheringPoint.StatesInstance>
{
	...
	private Chore CreateChore(int i)
	{
		...
		Chore chore = new WorkChore<SocialGatheringPointWorkable>(relax, target, null, null, true, null, null, OnSocialChoreEnd, false, recreation, false, true, null, false, true, false, PriorityScreen.PriorityClass.high, 5, false);
