...
public class DropToUserCapacity : Workable
{
	...
	public void UpdateChore()
	{
		...
		if (component != null && component.AmountStored > component.UserMaxCapacity)
		{
			if (chore == null)
			{
				chore = new WorkChore<DropToUserCapacity>(Db.Get().ChoreTypes.EmptyStorage, this, null, null, true, null, null, null, true, null, false, false, null, false, true, true, PriorityScreen.PriorityClass.basic, 5, false);
			}
		}
		else if (chore != null)
		{
