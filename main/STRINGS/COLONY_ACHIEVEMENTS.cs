namespace STRINGS
{
	public class COLONY_ACHIEVEMENTS
	{
		public class MISC_REQUIREMENTS
		{
			...
			public static LocString EQUIP_N_DUPES_DESCRIPTION = "Have {0} Duplicants wear non-default clothing simulatenously.";
		...
		{
			public static LocString NAME = "SURIVED";

			public static LocString DESCRIPTION = "The colony survived a long time!";
		}

		public class BUILT_WONDER
		{
			public static LocString NAME = "GREAT CONSTRUCTION";

			public static LocString DESCRIPTION = "Colony completed construction of a Wonder!";
		}

		public class COLLECTED_ARTIFACTS
		{
			public static LocString NAME = "ARTIFACTS";

			public static LocString DESCRIPTION = "The colony survived a long time!";
		}

		public static LocString ACHIEVED_THIS_COLONY_TOOLTIP = "This initiative was completed by this colony";

		public static LocString NOT_ACHIEVED_THIS_COLONY = "This Initiative has not been completed by this colony";

		public static LocString ACHIEVED_OTHER_CONOLOY_TOOLTIP = "A colony has completed this initiative";

		public static LocString NOT_ACHIEVED_EVER = "This Initiative has never been completed";
