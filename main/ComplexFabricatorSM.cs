public class ComplexFabricatorSM : StateMachineComponent<ComplexFabricatorSM.StatesInstance>
{
	...
	public class States : GameStateMachine<States, StatesInstance, ComplexFabricatorSM>
	{
		...
		public override void InitializeStates(out BaseState default_state)
		{
			...
			idle.idleQueue.ToggleStatusItem(Db.Get().BuildingStatusItems.FabricatorIdle, (object)null).EventTransition(GameHashes.FabricatorOrdersUpdated, idle.waitingForMaterial, (StatesInstance smi) => smi.master.fabricator.HasOpenOrder);
			idle.waitingForMaterial.ToggleStatusItem(Db.Get().BuildingStatusItems.FabricatorEmpty, (object)null).EventTransition(GameHashes.FabricatorOrdersUpdated, idle.idleQueue, (StatesInstance smi) => !smi.master.fabricator.HasOpenOrder).EventTransition(GameHashes.FabricatorOrdersUpdated, idle.waitingForWorker, (StatesInstance smi) => smi.master.fabricator.WaitingForWorker);
