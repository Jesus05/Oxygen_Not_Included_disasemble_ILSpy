...
public class EnergyGenerator : Generator, IEffectDescriptor, ISingleSliderControl, ISliderControl
{
	...
	public static void EnsureStatusItemAvailable()
	{
		...
		{
			batteriesSufficientlyFull = new StatusItem("BatteriesSufficientlyFull", "BUILDING", string.Empty, StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.None.ID, true, 63486);
		}
	}
