	...
	public class ClinicSM : GameStateMachine<ClinicSM, ClinicSM.Instance, Clinic>
	{
		...
		public override void InitializeStates(out BaseState default_state)
		{
			...
			operational.DefaultState(operational.idle).EventTransition(GameHashes.OperationalChanged, unoperational, (Instance smi) => !smi.master.GetComponent<Operational>().IsOperational).EventTransition(GameHashes.AssigneeChanged, unoperational, null)
				.ToggleRecurringChore((Instance smi) => new WorkChore<Clinic>(Db.Get().ChoreTypes.Heal, smi.master, null, null, true, null, null, null, true, null, false, true, null, false, true, false, PriorityScreen.PriorityClass.personalNeeds, 5, false, false), (Instance smi) => !string.IsNullOrEmpty(smi.master.healthEffect))
				.ToggleRecurringChore((Instance smi) => new WorkChore<Clinic>(Db.Get().ChoreTypes.HealCritical, smi.master, null, null, true, null, null, null, true, null, false, true, null, false, true, false, PriorityScreen.PriorityClass.personalNeeds, 5, false, false), (Instance smi) => !string.IsNullOrEmpty(smi.master.healthEffect))
				.ToggleRecurringChore((Instance smi) => new WorkChore<Clinic>(Db.Get().ChoreTypes.RestDueToDisease, smi.master, null, null, true, null, null, null, true, null, true, true, null, false, true, false, PriorityScreen.PriorityClass.personalNeeds, 5, false, false), (Instance smi) => !string.IsNullOrEmpty(smi.master.diseaseEffect))
				.ToggleRecurringChore((Instance smi) => new WorkChore<Clinic>(Db.Get().ChoreTypes.SleepDueToDisease, smi.master, null, null, true, null, null, null, true, null, true, true, null, false, true, false, PriorityScreen.PriorityClass.personalNeeds, 5, false, false), (Instance smi) => !string.IsNullOrEmpty(smi.master.diseaseEffect));
