...
public class IdleChore : Chore<IdleChore.StatesInstance>
{
	...
	public class States : GameStateMachine<States, StatesInstance, IdleChore>
	{
		...
		public override void InitializeStates(out BaseState default_state)
		{
			...
			}).Update("UpdateNavType", delegate(StatesInstance smi, float dt)
			{
				...
				.Update("Log idle time", delegate(StatesInstance smi, float dt)
				{
					ReportManager.Instance.ReportValue(ReportManager.ReportType.IdleTime, dt, idler.Get(smi).GetProperName(), null);
	...
	public IdleChore(IStateMachineTarget target)
		: base(Db.Get().ChoreTypes.Idle, target, target.GetComponent<ChoreProvider>(), false, (Action<Chore>)null, (Action<Chore>)null, (Action<Chore>)null, PriorityScreen.PriorityClass.idle, 5, false, true, 0, (Tag[])null, false)
	{
