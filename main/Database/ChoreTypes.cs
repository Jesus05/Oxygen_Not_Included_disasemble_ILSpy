...
namespace Database
{
	public class ChoreTypes : ResourceSet<ChoreType>
	{
			...
			: base("ChoreTypes", parent)
		{
			...
			{
				"Basekeeping"
			}, string.Empty, new string[0], DUPLICANTS.CHORES.EMPTYDESALINATOR.NAME, DUPLICANTS.CHORES.EMPTYDESALINATOR.STATUS, DUPLICANTS.CHORES.EMPTYDESALINATOR.TOOLTIP, false, 5000, null);
			...
			DoctorFetch = Add("DoctorFetch", new string[2]
			{
				"MedicalAid",
				"Hauling"
			}, string.Empty, new string[0], DUPLICANTS.CHORES.DOCTORFETCH.NAME, DUPLICANTS.CHORES.DOCTORFETCH.STATUS, DUPLICANTS.CHORES.DOCTORFETCH.TOOLTIP, false, 5000, DUPLICANTS.CHORES.DOCTORFETCH.REPORT_NAME);
			...
			{
				"MedicalAid"
			}, string.Empty, new string[0], DUPLICANTS.CHORES.COMPOUND.NAME, DUPLICANTS.CHORES.COMPOUND.STATUS, DUPLICANTS.CHORES.COMPOUND.TOOLTIP, false, 5000, null);
