...
public class MoveToSafetyChore : Chore<MoveToSafetyChore.StatesInstance>
{
	...
	public MoveToSafetyChore(IStateMachineTarget target)
		: base(Db.Get().ChoreTypes.MoveToSafety, target, target.GetComponent<ChoreProvider>(), false, (Action<Chore>)null, (Action<Chore>)null, (Action<Chore>)null, PriorityScreen.PriorityClass.idle, 5, false, true, 0, (Tag[])null, false, ReportManager.ReportType.WorkTime)
	{
