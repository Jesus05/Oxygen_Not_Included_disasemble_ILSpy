...
namespace Steamworks
{
	public class ISteamMatchmakingPlayersResponse
	{
		...
		public ISteamMatchmakingPlayersResponse(AddPlayerToList onAddPlayerToList, PlayersFailedToRespond onPlayersFailedToRespond, PlayersRefreshComplete onPlayersRefreshComplete)
		{
			...
			m_VTable = new VTable
			{
				m_VTAddPlayerToList = new InternalAddPlayerToList(InternalOnAddPlayerToList),
				m_VTPlayersFailedToRespond = new InternalPlayersFailedToRespond(InternalOnPlayersFailedToRespond),
				m_VTPlayersRefreshComplete = new InternalPlayersRefreshComplete(InternalOnPlayersRefreshComplete)
			};
