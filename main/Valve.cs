	...
	public void ChangeFlow(float amount)
	{
		...
		else if (desiredFlow != valveBase.CurrentFlow)
		{
			if (chore == null)
			{
				...
				chore = new WorkChore<Valve>(Db.Get().ChoreTypes.Toggle, this, null, null, true, null, null, null, true, null, false, false, null, false, true, true, PriorityScreen.PriorityClass.basic, 5, false);
			}
		}
		else
		{
