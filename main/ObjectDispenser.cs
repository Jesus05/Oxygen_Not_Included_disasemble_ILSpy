...
public class ObjectDispenser : Switch, IUserControlledCapacity
{
	...
	protected override void OnSpawn()
	{
		...
		{
			infoStatusItem = new StatusItem("ObjectDispenserAutomationInfo", "BUILDING", string.Empty, StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.None.ID, true, 63486);
