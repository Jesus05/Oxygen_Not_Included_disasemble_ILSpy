...
namespace Database
{
	public class ChoreTypes : ResourceSet<ChoreType>
	{
			...
			: base("ChoreTypes", parent)
		{
			...
			SwitchHat = Add("SwitchHat", new string[0], "", new string[0], DUPLICANTS.CHORES.SWITCHROLE.NAME, DUPLICANTS.CHORES.SWITCHROLE.STATUS, DUPLICANTS.CHORES.SWITCHROLE.TOOLTIP, false, -1, null);
