...
public class LogicMemory : KMonoBehaviour
{
	...
	protected override void OnSpawn()
	{
		...
		{
			infoStatusItem = new StatusItem("StoredValue", "BUILDING", string.Empty, StatusItem.IconType.Info, NotificationType.Neutral, false, OverlayModes.None.ID, true, 63486);
