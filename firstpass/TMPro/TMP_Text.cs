...
namespace TMPro
{
	public class TMP_Text : MaskableGraphic
	{
		...
		public TMP_FontAsset font
		{
			...
			set
			{
				if (!((UnityEngine.Object)m_fontAsset == (UnityEngine.Object)value))
				{
					m_fontAsset = value;
					LoadFontAsset();
					m_havePropertiesChanged = true;
		...
		public virtual Material fontSharedMaterial
		{
			...
			set
			{
				if (!((UnityEngine.Object)m_sharedMaterial == (UnityEngine.Object)value))
				{
		...
		public TMP_Text linkedTextComponent
		{
			...
			set
			{
				if ((UnityEngine.Object)m_linkedTextComponent != (UnityEngine.Object)value)
				{
		...
		protected LayoutElement layoutElement
		{
			get
			{
				if ((UnityEngine.Object)m_LayoutElement == (UnityEngine.Object)null)
				{
		...
		{
			if (!((UnityEngine.Object)gradient == (UnityEngine.Object)null))
			{
		...
		protected virtual void SaveGlyphVertexInfo(float padding, float style_padding, Color32 vertexColor)
		{
			...
			else if ((UnityEngine.Object)m_fontColorGradientPreset != (UnityEngine.Object)null)
			{
				m_textInfo.characterInfo[m_characterCount].vertex_BL.color = m_fontColorGradientPreset.bottomLeft * (Color)vertexColor;
				m_textInfo.characterInfo[m_characterCount].vertex_TL.color = m_fontColorGradientPreset.topLeft * (Color)vertexColor;
				m_textInfo.characterInfo[m_characterCount].vertex_TR.color = m_fontColorGradientPreset.topRight * (Color)vertexColor;
				m_textInfo.characterInfo[m_characterCount].vertex_BR.color = m_fontColorGradientPreset.bottomRight * (Color)vertexColor;
			}
			else
			{
				m_textInfo.characterInfo[m_characterCount].vertex_BL.color = m_fontColorGradient.bottomLeft * (Color)vertexColor;
				m_textInfo.characterInfo[m_characterCount].vertex_TL.color = m_fontColorGradient.topLeft * (Color)vertexColor;
				m_textInfo.characterInfo[m_characterCount].vertex_TR.color = m_fontColorGradient.topRight * (Color)vertexColor;
				m_textInfo.characterInfo[m_characterCount].vertex_BR.color = m_fontColorGradient.bottomRight * (Color)vertexColor;
			}
			if ((UnityEngine.Object)m_colorGradientPreset != (UnityEngine.Object)null)
			{
				ref TMP_Vertex vertex_BL = ref m_textInfo.characterInfo[m_characterCount].vertex_BL;
				vertex_BL.color = (Color)vertex_BL.color * m_colorGradientPreset.bottomLeft;
				ref TMP_Vertex vertex_TL = ref m_textInfo.characterInfo[m_characterCount].vertex_TL;
				vertex_TL.color = (Color)vertex_TL.color * m_colorGradientPreset.topLeft;
				ref TMP_Vertex vertex_TR = ref m_textInfo.characterInfo[m_characterCount].vertex_TR;
				vertex_TR.color = (Color)vertex_TR.color * m_colorGradientPreset.topRight;
				ref TMP_Vertex vertex_BR = ref m_textInfo.characterInfo[m_characterCount].vertex_BR;
				vertex_BR.color = (Color)vertex_BR.color * m_colorGradientPreset.bottomRight;
			}
			if (!m_isSDFShader)
			{
				style_padding = 0f;
