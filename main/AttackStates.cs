...
internal class AttackStates : GameStateMachine<AttackStates, AttackStates.Instance, IStateMachineTarget, AttackStates.Def>
{
	...
	public override void InitializeStates(out BaseState default_state)
	{
		...
		state2.ToggleStatusItem(tooltip, name, "", StatusItem.IconType.Info, NotificationType.Neutral, false, default(HashedString), 63486, null, null, main).OnAnimQueueComplete(behaviourcomplete);
