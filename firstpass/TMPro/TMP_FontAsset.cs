...
namespace TMPro
{
	...
	public class TMP_FontAsset : TMP_Asset
	{
		...
		public static TMP_FontAsset defaultFontAsset
		{
			get
			{
				if ((UnityEngine.Object)s_defaultFontAsset == (UnityEngine.Object)null)
				{
		...
		public void ReadFontDefinition()
		{
			if (m_fontInfo != null)
			{
				...
				for (int j = 0; j < kerningPairs.Count; j++)
				{
					...
					{
						Debug.LogWarning("Kerning Key for [" + kerningPairKey.ascii_Left + "] and [" + kerningPairKey.ascii_Right + "] already exists.", null);
					}
				}
