...
namespace TMPro
{
	...
	public class TextMeshPro : TMP_Text, ILayoutElement
	{
		...
		public new Transform transform
		{
			get
			{
				if ((UnityEngine.Object)m_transform == (UnityEngine.Object)null)
				{
		...
		{
			if (!m_verticesAlreadyDirty && !((UnityEngine.Object)this == (UnityEngine.Object)null) && IsActive())
			{
		...
		{
			if ((UnityEngine.Object)m_textInfo.meshInfo[0].mesh == (UnityEngine.Object)null)
			{
		...
		protected override void Awake()
		{
			...
			if ((UnityEngine.Object)base.canvasRenderer != (UnityEngine.Object)null)
			{
		...
		protected override void LoadFontAsset()
		{
			...
			else
			{
				...
				if ((UnityEngine.Object)m_renderer.sharedMaterial == (UnityEngine.Object)null || (UnityEngine.Object)m_renderer.sharedMaterial.GetTexture(ShaderUtilities.ID_MainTex) == (UnityEngine.Object)null || m_fontAsset.atlas.GetInstanceID() != m_renderer.sharedMaterial.GetTexture(ShaderUtilities.ID_MainTex).GetInstanceID())
				{
					m_renderer.sharedMaterial = m_fontAsset.material;
					m_sharedMaterial = m_fontAsset.material;
				}
		...
		{
			if (m_isMaskingEnabled && m_isMaskingEnabled && (UnityEngine.Object)m_fontMaterial == (UnityEngine.Object)null)
			{
		...
		protected override void SetSharedMaterials(Material[] materials)
		{
			...
			for (int i = 0; i < materialCount; i++)
			{
				...
				if (i == 0)
				{
					if (!((UnityEngine.Object)texture == (UnityEngine.Object)null) && texture.GetInstanceID() == m_sharedMaterial.GetTexture(ShaderUtilities.ID_MainTex).GetInstanceID())
					{
						m_sharedMaterial = (m_fontSharedMaterials[i] = materials[i]);
						m_padding = GetPaddingForMaterial(m_sharedMaterial);
					}
				}
				else if (!((UnityEngine.Object)texture == (UnityEngine.Object)null) && texture.GetInstanceID() == m_subTextObjects[i].sharedMaterial.GetTexture(ShaderUtilities.ID_MainTex).GetInstanceID() && m_subTextObjects[i].isDefaultMaterial)
				{
		...
		protected override void SetCulling()
		{
			...
			else
			{
				...
				for (int j = 1; j < m_subTextObjects.Length && (UnityEngine.Object)m_subTextObjects[j] != (UnityEngine.Object)null; j++)
				{
					...
					if ((UnityEngine.Object)renderer2 != (UnityEngine.Object)null)
					{
				...
				else
				{
					...
					for (int i = 0; i < m_char_buffer.Length && m_char_buffer[i] != 0; i++)
					{
						...
						if (m_textElementType == TMP_TextElementType.Sprite)
						{
							...
							m_currentFontAsset = m_fontAsset;
							float num19 = m_currentFontSize / m_fontAsset.fontInfo.PointSize * m_fontAsset.fontInfo.Scale * ((!m_isOrthographic) ? 0.1f : 1f);
							...
							for (int num52 = 0; num52 < m_characterCount; num52++)
							{
								...
								if (isVisible)
								{
									...
									case TMP_TextElementType.Character:
									{
										...
										num44 = characterInfo[num52].scale * num43 * (1f - m_charWidthAdjDelta);
									...
									{
									case TMP_TextElementType.Character:
										FillCharacterVertexBuffers(num52, index_X, m_isVolumetricText);
										break;
								...
								bool flag14 = (m_textInfo.characterInfo[num52].style & FontStyles.Strikethrough) == FontStyles.Strikethrough;
								...
								if (flag14)
								{
									...
									if (!flag2 && flag15 && num52 <= tMP_LineInfo.lastVisibleCharacterIndex && character3 != '\n' && character3 != '\r' && (num52 != tMP_LineInfo.lastVisibleCharacterIndex || !char.IsSeparator(character3)))
									{
										flag2 = true;
								...
								if ((m_textInfo.characterInfo[num52].style & FontStyles.Highlight) == FontStyles.Highlight)
								{
									...
									if (!flag3 && flag16 && num52 <= tMP_LineInfo.lastVisibleCharacterIndex && character3 != '\n' && character3 != '\r' && (num52 != tMP_LineInfo.lastVisibleCharacterIndex || !char.IsSeparator(character3)))
									{
										flag3 = true;
		...
		private void SetMeshFilters(bool state)
		{
			...
			for (int i = 1; i < m_subTextObjects.Length && (UnityEngine.Object)m_subTextObjects[i] != (UnityEngine.Object)null; i++)
			{
				if ((UnityEngine.Object)m_subTextObjects[i].meshFilter != (UnityEngine.Object)null)
				{
					if (state)
					{
		...
		protected override void ClearSubMeshObjects()
		{
			for (int i = 1; i < m_subTextObjects.Length && (UnityEngine.Object)m_subTextObjects[i] != (UnityEngine.Object)null; i++)
			{
				Debug.Log("Destroying Sub Text object[" + i + "].", null);
