...
namespace Klei.AI
{
	...
	public abstract class Disease : Resource
	{
		...
		public List<Descriptor> GetSymptoms()
		{
			...
			list.Add(new Descriptor(Strings.Get("STRINGS.DUPLICANTS.DISEASES." + Id.ToUpper() + ".DESCRIPTION"), Strings.Get("STRINGS.DUPLICANTS.DISEASES." + Id.ToUpper() + ".DESCRIPTION"), Descriptor.DescriptorType.Information, false));
			for (int i = 0; i < components.Count; i++)
			{
