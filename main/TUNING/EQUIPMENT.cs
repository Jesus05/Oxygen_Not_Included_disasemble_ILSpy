namespace TUNING
{
	public class EQUIPMENT
	{
		...
		public class SUITS
		{
			...
			public static int AQUASUIT_ATHLETICS = ATMOSUIT_ATHLETICS;

			public static int AQUASUIT_MASS = ATMOSUIT_MASS;

			public static int AQUASUIT_UNDERWATER_TRAVELCOST = 6;

			public static int TEMPERATURESUIT_FABTIME = ATMOSUIT_FABTIME;
		...
		public class VESTS
		{
			...
			public static float COOL_VEST_FABTIME = WARM_VEST_FABTIME;
