...
public class AlgaeHabitat : StateMachineComponent<AlgaeHabitat.SMInstance>
{
	public class SMInstance : GameStateMachine<States, SMInstance, AlgaeHabitat, object>.GameInstance
	{
		...
		public void CreateEmptyChore()
		{
			...
			emptyChore = new WorkChore<AlgaeHabitatEmpty>(Db.Get().ChoreTypes.EmptyStorage, component, null, null, true, OnEmptyComplete, null, null, true, null, false, true, null, false, true, true, PriorityScreen.PriorityClass.basic, 5, true);
		}
